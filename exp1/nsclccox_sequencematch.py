...
@ALGORITHMS.register('nsclccox_sequencematch')
class NSCLCCoxSequenceMatch(AlgorithmBase):
    """
...
#######################################2
                ...
                inputs=[]
                for x1,x2,x3,x4 in zip(x_lb, x_ulb_w, x_ulb_m, x_ulb_s):
                    inputs.append(torch.cat((x1,x2,x3,x4)))
