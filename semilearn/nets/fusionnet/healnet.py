...
def hlnet_1img_52pro(pretrained=False, pretrained_path=None, num_classes=2,**kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    model_kwargs = dict(
        n_modalities = 2,
    ...
    model = SemiHealNet(**model_kwargs)
    # if pretrained:
    #     model = load_checkpoint(model, pretrained_path)
    # return model
    return model

def hlnet_3mod_52pro(pretrained=False, pretrained_path=None, num_classes=2,**kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    model_kwargs = dict(
        n_modalities = 3,
...
class SemiHealNet(nn.Module):
    ...
    def forward(self,
        ...
        result_dict = {'logits':self.to_logits(x), 'feat':x}
        return result_dict
