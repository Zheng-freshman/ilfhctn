...
class Mona(nn.Module):
    ...
    def forward(self, x, hw_shapes=None):
        ...
        if hw_shapes is None:
            ...
            h, w = hw_shapes
        cls_token = project1[:, 0:1]
        project1 = project1[:, 1:].reshape(b, h, w, c).permute(0, 3, 1, 2)
        project1 = self.adapter_conv(project1)
        project1 = project1.permute(0, 2, 3, 1).reshape(b, h*w, c)
        project1 = torch.cat((cls_token,project1), dim=1)
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.mona1 = Mona(dim, 8)
        self.mona2 = Mona(dim, 8)
...
def monet_3Dimg_6in1(pretrained=False, pretrained_path=None, num_classes=2, fusing=True, pretrained_from="ViT", context_depth=4,**kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    embed_dim = 384
    model_kwargs = dict(
    ...
    model = FusionNetMona(**model_kwargs)
    fromViT = False
...
def monet_2img_52in1(pretrained=False, pretrained_path=None, num_classes=2, fusing=True, pretrained_from="ViT", context_depth=4, l_c=1, l_d=384, **kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    embed_dim = 384
    model_kwargs = dict(
...
def monet_1img_52pro(pretrained=False, pretrained_path=None, num_classes=2, fusing=True, pretrained_from="ViT", context_depth=4, **kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    embed_dim = 384
    model_kwargs = dict(
...
def monet_2img_5groups(pretrained=False, pretrained_path=None, num_classes=2, fusing=True, pretrained_from="ViT", context_depth=4,**kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    embed_dim = 384
    model_kwargs = dict(
...
def monet_1img_52in1(pretrained=False, pretrained_path=None, num_classes=2, fusing=True, pretrained_from="ViT", context_depth=4,**kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
    embed_dim = 384
    model_kwargs = dict(
